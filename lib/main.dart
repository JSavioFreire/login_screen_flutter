...
import 'package:project/service/check_is_login.dart';
import 'package:project/theme/my_theme.dart';
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(
          create: (context) => FunctionAuthProvider(context: context))
    ],
    child: const MyApp(),
  ));
}
